...
TextStyle style15_black_bold = TextStyle(fontSize: 15, color: Colors.black, fontWeight: FontWeight.bold);
...
TextStyle style13_blue = TextStyle(fontSize: 13,fontWeight: FontWeight.bold, color: MyColor.normalColor);
TextStyle style20_red   = TextStyle(fontSize: 16, color: Colors.red);
TextStyle appbar_style20_blue   = TextStyle(fontSize: 20, color: Color(0xff033572), fontWeight: FontWeight.bold);
TextStyle style13_blue_underline   = TextStyle(fontSize: 13, color: MyColor.normalColor, fontWeight: FontWeight.bold);

TextStyle style20_blue = TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: MyColor.normalColor);